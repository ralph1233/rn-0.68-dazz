...
import {base64 as lutBase64} from '../LUTs/arabica';
...
export const Arabica = async (
  photoUrl,
  imageWidth,
  imageHeight,
  isFileFromCameraRoll,
) => {
  ...
  const base64 = isFileFromCameraRoll
    ? (await CameraRoll.getPhotoThumbnail(photoUrl)).thumbnailBase64
    : await RNFS.readFile(photoUrl, 'base64');
    ...
    <Group
      ...
      <Shader source={shader} uniforms={{}}>
        <ImageShader
          ...
          sampling={MitchellCubicSampling}
        />
        <ImageShader
          fit="cover"
          image={lutImage}
